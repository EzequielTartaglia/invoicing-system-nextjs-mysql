...
INSERT INTO user (user_name, user_last_name, user_email, user_account, user_password, user_is_active, user_is_banned, user_created, user_modified) VALUES
  ('Ezequiel', 'Tartaglia', 'ezequielmtartaglia@gmail.com',"Ezequiel Software Engineer",'123123123',TRUE,FALSE,now(),now());
